function [cascaded, cascaded_adaptive,master] = MRAC_startup(perc,master)
clc;close all;
addpath(pwd);
%%
sim_choice=1; % TURN ON IF YOU WANT TO RUN A SIM
%%
plot_choice=0; % Do you want the plots or no?

if sim_choice
    clc;clearvars -except perc plot_choice master;close all;
    %%
    ...
    if nargin<1
        ...
        perc=50; % MANIPULATE THE PARAMETER PERTURBATION PERCENTAGE
    end
    if nargin<2
